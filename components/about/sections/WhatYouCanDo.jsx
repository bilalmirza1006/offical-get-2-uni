...
const WhatYouCanDo = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'See course fees, duration, entry requirements, and more — all in clear detail',
    },
    {
      icon: <Bookmark />,
      title: 'Shortlist & Apply',
      description: 'Save your favorite courses and apply directly through our simple platform',
    },
    {
      icon: <Screen />,
      title: 'Expert Consultation',
      description: 'Need help deciding? Our team offers expert guidance and easy online sessions',
    },
  ];
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-gray-600 text-base md:text-lg max-w-3xl mx-auto">
            Get2Uni helps you explore study options worldwide with tools that make choosing the
            right course, country, and university easy — all in one place.
          </p>
        </div>
