...
const AboutUniversityCard = ({
  ...
  const handleNavigate = () => {
    router.push(`/pages/home/instant-find/${id}`);
  };
      ...
      <div className="mt-3.5">
        ...
        <div className="space-y-3.5">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2 text-white bg-[#190459] rounded-[4px] p-1">
              ...
              <p>
                Document Required : <span className="font-semibold ">{documents}</span>
              </p>
            </div>
          </div>
          <p className="font-medium font-inter text-sm text-primarycolor">
        ...
        <div className="flex gap-2 mt-4">
          <button
            ...
            className={`flex-1 border font-semibold py-2 rounded-lg text-sm transition-all ${
              shortlisted
